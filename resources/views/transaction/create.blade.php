...
<div class="col-xs-12 col-md-12">
    <!-- general form elements -->
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="/transactions/store" method="post" role="form">
              ...
              <div class="box-body">
                ...
                <div class="form-group col-xs-4 col-md-4">
                  ...
                  @foreach($types as $id => $description)
                      <option value="{{ $id }}"{{ (old("type") == $id ? "selected":"") }}> {{ $description }} </option>
                  @endforeach
                  </select>
                </div>
                <div class="form-group col-xs-4 col-md-4">
                ...
                <div class="form-group col-xs-4 col-md-4">
                  ...
                  @foreach($operations as $id => $description)
                      <option value="{{ $id }}" {{ (old("operation") == $id ? "selected":"") }}> {{ $description }} </option>
                  @endforeach
                  </select>
                </div>
                <div class="form-group col-xs-4 col-md-4">
                  <label for="value">Valor</label>
                  <input type="text" class="form-control money" name="value" id="value" value="{{ old('value') }}" maxlength="100">
                </div>
                <div class="form-group col-xs-4 col-md-4">
